    ...
    <Popover.Root>
      ...
      >
        {localUserReacted.length > 0 ? (
          <HeartIconFill
            className={`${iconSize} transition-transform scale-90 fill-red-700`}
          />
        ) : (
          <HeartIcon
            className={`${iconSize} transition-all scale-90 group-hover:fill-red-700 group-hover:scale-105`}
          />
        )}
