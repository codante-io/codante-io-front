...
export default function ChallengeCard({
  ...
  return (
    <article className="mx-auto w-[300px] bg-white dark:bg-zinc-800 shadow-md rounded-2xl p-6 pt-3 font-lexend border-[1.5px] border-gray-300 dark:border-slate-600">
