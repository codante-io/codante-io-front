...
const sheetVariants = cva(
  "fixed z-50 gap-4 dark:bg-background-800 bg-background-100 p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 border-background-700",
  {
    variants: {
      side: {
