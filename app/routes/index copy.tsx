  ...
  return (
    ...
    >
      <div className="container flex flex-col items-center">
        ...
        >
          <h1 className="text-3xl text-start md:mt-10 font-lexend lg:text-5xl max-w-2xl">
            Domine o frontend moderno e seja um dev de sucesso
          </h1>
          <h2 className="text-xl dark:text-gray-300 text-gray-800 font-light text-start font-lexend lg:text-xl max-w-2xl">
