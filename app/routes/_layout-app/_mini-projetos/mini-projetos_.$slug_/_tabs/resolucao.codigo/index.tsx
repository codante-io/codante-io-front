  ...
  return (
    <section className="container">
      ...
      <div className="mt-10 w-full flex gap-10">
        <a
          className={`dark:bg-[#17212B] flex gap-2 items-center shadow bg-white border-[1.5px] group dark:hover:border-brand-500 hover:border-brand-500 border-background-200 justify-between dark:border-background-700 w-full rounded-lg p-5`}
          href="https://codante.io"
          target="_blank"
          rel="noopener noreferrer"
        >
          <p className="text-lg">Acessar o código no GitHub</p>
          <BsGithub className="text-3xl group-hover:text-brand-500 text-background-200 dark:text-background-600" />
        </a>

        <a
          className={`dark:bg-[#17212B] justify-between flex gap-2 items-center shadow bg-white border-[1.5px] group dark:hover:border-brand-500 hover:border-brand-500 border-background-200 dark:border-background-700 w-full rounded-lg p-5`}
          href="https://codante.io"
          target="_blank"
          rel="noopener noreferrer"
        >
          <p className="text-lg">Acessar o deploy da aplicação</p>
