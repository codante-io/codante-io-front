...
export default function OrderBySelect() {
  ...
  return (
    <Select value={selectedOption} onValueChange={setSelectedOption}>
      <SelectTrigger className="w-full min-w-48 border-[1.5px] border-background-300 rounded-md focus:outline-hidden focus:border-brand-300 dark:bg-background-800 dark:text-gray-300 dark:border-background-600 font-light">
