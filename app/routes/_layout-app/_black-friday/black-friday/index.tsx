  ...
  return (
    <>
            ...
            <div className="w-full">
              ...
              <p className="font-light font-inter text-xl max-w-[670px] mt-12 dark:text-gray-100 text-gray-700">
                ...
                <span className="text-lg">
                  Depois da Black Friday, o plano vitalício mudará para o valor
                  cheio de{" "}
                  <span className="inline-block dark:bg-background-700 bg-background-100 px-2 py-1 rounded-md italic font-bold rotate-3">
                    R$1788
                  </span>
                </span>
                <br />
              ...
              <div className="md:mt-12 mt-4 dark:text-gray-200 text-gray-700">
                <span className="text-2xl italic font-normal color-underline decoration-amber-400">
                  Aproveite essa oferta
                </span>
                <ul className="font-lexend text-lg space-y-2 mt-4">
                  <li>
                    <BadgeCheck className="w-5 h-5 mr-1 inline-block text-amber-400" />{" "}
                    <span className="font-bold">Acesso vitalício:</span> pague
                    uma vez, acesse para sempre
                  </li>
                  <li>
                    <BadgeCheck className="w-5 h-5 mr-1 inline-block text-amber-400" />{" "}
                    <span className="font-bold">Preço promocional:</span>{" "}
                    vitalício pelo preço do plano anual
                  </li>
                  <li>
                    {" "}
                    <BadgeCheck className="w-5 h-5 mr-1 inline-block text-amber-400" />{" "}
                    <span className="font-bold">3 bônus especiais:</span> acesso
                    exclusivo a nossos bônus de Black Friday
                  </li>
                </ul>
              </div>

              <div className="md:mt-16 mt-4 dark:text-gray-200 text-gray-700 dark:bg-background-700 bg-background-100 border border-amber-400 p-4 rounded-lg">
                <p>
                  <span className="italic font-bold">
                    <IoWarning className="w-5 h-5 mr-1 inline-block text-amber-400" />
                    Atenção:
                  </span>{" "}
                  Os bônus são limitados às 20 primeiras pessoas que se
                  inscreverem durante a Black Friday.
                </p>
              </div>
            </div>
      ...
      <section id="bonus" className="flex flex-col items-center w-full mb-16">
        ...
        <h1 className="text-3xl lg:text-4xl font-light font-lexend text-center dark:text-shadow">
          Bônus exclusivos
        </h1>
        <div className="mx-10 md:mt-16 mt-10 dark:text-gray-200 text-gray-700 dark:bg-background-700 bg-background-100 border border-amber-400 p-4 rounded-lg">
          <p>
            <span className="italic font-bold">
              <IoWarning className="w-5 h-5 mr-1 inline-block text-amber-400" />
              Atenção:
            </span>{" "}
            Os bônus são limitados às 20 primeiras pessoas que se inscreverem
