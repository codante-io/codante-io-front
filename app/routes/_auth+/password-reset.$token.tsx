  ...
  return (
    <main>
      ...
      <form method="post">
        ...
        <input name="password" type="password" id="password" className="text-black"/>
        <label htmlFor="password_confirmation" >Password Confirmation</label>
        <input name="password_confirmation" type="password" id="password_confirmation" className="text-black" />
        <button type="submit" className="m-3 p-3 bg-blue-900">Reset Password</button>
      </form>
    </main>
  );
}