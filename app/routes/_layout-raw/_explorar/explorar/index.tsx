  ...
  return (
    <>
      ...
      <div className="text-center">
        ...
        <section className="container relative flex items-center gap-2 mx-auto">
          <button
            onMouseUp={() => scroll("left")}
            className="absolute flex items-center justify-center w-12 h-12 p-2 left-24 rounded-xl bg-background-800 border-background-600 hover:bg-background-700"
          >
          ...
          <button
            ...
            className="absolute flex items-center justify-center w-12 h-12 p-2 rounded-xl bg-background-800 border-background-600 hover:bg-background-700 right-24"
          >
