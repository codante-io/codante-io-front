...
export default function Sidebar({
  ...
  return (
    <div
      ref={ref}
      className={`sticky top-6 w-80 max-h-screen overflow-y-auto left-0 z-10 bg-background-100 dark:bg-background-900 lg:dark:bg-transparent lg:bg-transparent duration-500 transition-all  lg:opacity-100 lg:flex  lg:visible flex flex-col gap-10`}
    >
