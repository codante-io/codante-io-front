...
export default function ChallengeSlug() {
  ...
  const tabs: {
  ...
  }[] = [
    {
      ...
      href: "",
      current:
        location.pathname === `/demo/mini-projetos/${challenge?.slug}` ||
        location.pathname === `/demo/mini-projetos/${challenge?.slug}/`,
    },
    {
      name: "Resolução",
  ...
  return (
    <div className="flex flex-col items-center justify-center -mb-10 text-gray-900 dark:text-gray-50 relative pt-12 bg-background-900">
