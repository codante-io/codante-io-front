...
import FullPlayer from "~/routes/_layout-raw/_routes/demo/workshops_.$workshopSlug_.$slug/components/full-player/full-player";
...
export default function LessonIndex() {
  ...
  return (
    <div className="w-full h-full dark:bg-background-900 bg-background-100 z-10 relative">
      <FullPlayer
