...
// routes/_layout-app/_auth/password-reset.$token/index.tsx
...
export type Info = {
  ...
  id: "routes/_layout-app/_auth/password-reset.$token/index";
  file: "routes/_layout-app/_auth/password-reset.$token/index.tsx";
