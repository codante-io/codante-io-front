...
// routes/_layout-app/_auth/auth/github.callback/index.tsx
...
import type { Info as Parent3 } from "../../github/+types/index.js";

type Module = typeof import("../index.js");

export type Info = {
  parents: [Parent0, Parent1, Parent2, Parent3];
  id: "routes/_layout-app/_auth/auth/github.callback/index";
  file: "routes/_layout-app/_auth/auth/github.callback/index.tsx";
  path: "callback";
